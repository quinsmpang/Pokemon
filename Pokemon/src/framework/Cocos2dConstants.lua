...
cc.Handler.CONTROL_TOUCH_DOWN = 1
cc.Handler.CONTROL_TOUCH_DRAG_INSIDE = 2
cc.Handler.CONTROL_TOUCH_DRAG_OUTSIDE = 4
cc.Handler.CONTROL_TOUCH_DRAG_ENTER = 8
cc.Handler.CONTROL_TOUCH_DRAG_EXIT  = 16
cc.Handler.CONTROL_TOUCH_UP_INSIDE  = 32
cc.Handler.CONTROL_TOUCH_UP_OUTSIDE = 64
cc.Handler.CONTROL_TOUCH_UP_CANCEL  = 128
cc.Handler.CONTROL_VALUE_CHANGED    = 256
...
cc.Handler.TABLECELL_TOUCHED        = 2
cc.Handler.TABLECELL_HIGHLIGHT      = 3
cc.Handler.TABLECELL_UNHIGHLIGHT    = 4
cc.Handler.TABLECELL_WILL_RECYCLE   = 5
cc.Handler.TABLECELL_SIZE_FOR_INDEX = 6
cc.Handler.TABLECELL_AT_INDEX       = 7
cc.Handler.TABLEVIEW_NUMS_OF_CELLS  = 8
