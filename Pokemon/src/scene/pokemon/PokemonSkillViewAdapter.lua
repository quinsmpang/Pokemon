...
function PokemonSkillViewAdapter:adapt(detailView)
	...
	local skillBorder = cc.Scale9Sprite:createWithSpriteFrameName("images/common/back_white.png", CCRectMake(10, 10, 30, 30))
	...
	local descriptionBorder = cc.Scale9Sprite:createWithSpriteFrameName("images/common/back_white.png", CCRectMake(10, 10, 30, 30))
	...
	local effectBorder = cc.Scale9Sprite:createWithSpriteFrameName("images/common/back_white.png", CCRectMake(10, 10, 30, 30))
