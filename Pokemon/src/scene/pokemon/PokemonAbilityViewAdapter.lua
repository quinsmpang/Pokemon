...
function PokemonAbilityViewAdapter:adapt(detailView)
	...
	local itemBorder = cc.Scale9Sprite:createWithSpriteFrameName("images/common/back_white.png", CCRectMake(10, 10, 30, 30))
	...
	local abilityBorder = cc.Scale9Sprite:createWithSpriteFrameName("images/common/back_white.png", CCRectMake(10, 10, 30, 30))
	...
	local expBorder = cc.Scale9Sprite:createWithSpriteFrameName("images/common/back_white.png", CCRectMake(10, 10, 30, 30))
