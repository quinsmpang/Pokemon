...
--------------------------------
-- @function [parent=#GameScene] getRefAttribute 
-- @param self
-- @param #string str
-- @return Ref#Ref ret (return value: cc.Ref)
        
--------------------------------
-- @function [parent=#GameScene] putBoolAttribute 
-- @param self
-- @param #string str
-- @param #bool bool
        
--------------------------------
-- @function [parent=#GameScene] getDoubleAttribute 
-- @param self
-- @param #string str
...
--------------------------------
-- @function [parent=#GameScene] getIntAttribute 
-- @param self
-- @param #string str
-- @return int#int ret (return value: int)
        
--------------------------------
-- @function [parent=#GameScene] getBoolAttribute 
-- @param self
-- @param #string str
-- @return bool#bool ret (return value: bool)
