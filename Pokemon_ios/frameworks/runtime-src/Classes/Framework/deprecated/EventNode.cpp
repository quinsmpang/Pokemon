#include "EventNode.h"
#include "lua/ScriptEventExtend.h"
...
namespace framework
{
	...
	int EventNode::onScriptTouch(cocos2d::Ref *pSender)
	{
		EventNodeTouchScriptData data(this, pSender);
		framework::ScriptEvent scriptEvent(framework::ScriptEventType::kEventNodeTouchEvent, &data);
		return LuaUtils::sendCustomEvent(&scriptEvent);
	}
	...
	int EventNode::onScriptKeyPressed(cocos2d::Ref *pSender, cocos2d::EventKeyboard::KeyCode keyCode)
	{
		EventNodeKeyboardScriptData data(this, pSender, keyCode);
		framework::ScriptEvent scriptEvent(framework::ScriptEventType::kEventNodeKeyboardEvent, &data);
		return LuaUtils::sendCustomEvent(&scriptEvent);
	}
#endif
